...
use App\Http\Controllers\CongregantsController;
use App\Http\Controllers\SacrificersController;
...
Route::resource('/congregants', CongregantsController::class);
Route::resource('/sacrificers', SacrificersController::class);
